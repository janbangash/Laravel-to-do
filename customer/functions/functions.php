		...
		$row_c = mysqli_fetch_array($run_c); 
			...
			if (!isset($_GET['my_orders'])) {
				...
				if ($count_orders>0) {
					...
					<h3>Please See Your Orders Details by clicking this <a href='my_account.php?my_orders'>LINK</a><br> or You can <a href='pay_offline.php' target='_blank'>Pay Offline Now</a></h3>
					</div>
						";
				}
				else {
